            ...
            <div class="bg-indigo-50 p-4 rounded-lg mb-6 border border-indigo-200 shadow-sm">
                <form action="/ticket/assign" method="POST" class="flex flex-col sm:flex-row sm:items-end gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <select name="agent_id" class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500 bg-white">
                    ...
                    <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded text-sm font-semibold hover:bg-indigo-700 transition h-[42px]">
                        Spremi dodjelu
                    </button>
                </form>
            </div>
            ...
            <div class="bg-white p-6 shadow-md rounded-lg border border-gray-200">
                <form action="/ticket/reply" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="message" rows="4" required placeholder="Upišite svoj komentar ovdje..." class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                    </div>

                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <div class="w-full sm:w-auto">
                            <label class="block text-xs font-semibold text-gray-500 mb-1 uppercase">Status ticketa</label>
                            <select name="status" class="w-full sm:w-auto border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 font-medium">
